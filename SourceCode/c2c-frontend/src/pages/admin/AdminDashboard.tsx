...
import { BarChart3, Package, Users, CreditCard, ArrowRight, AlertTriangle, ShoppingCart } from 'lucide-react'; // Thêm icon ShoppingCart
import { getAdminDashboardStats } from '../../services/adminService';
import { formatCurrency } from '../../utils/format';

const AdminDashboard = () => {
  const [isLoading, setIsLoading] = useState(true);
  // Thêm pendingOrders vào state
  const [stats, setStats] = useState({
    ...
    totalRevenue: 0,
    pendingProducts: 0,
    pendingOrders: 0, // State mới cho đơn hàng chờ xử lý
  });
  ...
  return (
    <div>
      ...
      {/* Phần thống kê tổng quan không đổi */}
